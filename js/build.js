! function(t) {
	...
	t.exports = i("skills-2", function(t, e) {
		...
		var s = this,
			...
			r = "";
		return r += ' <div class="skills"> <div class="skills_bottom"> <div class="bottom_con"> <div class="skills_title"> <h3>技能展示</h3> <p>喜欢原生js，喜欢研究各种新技术</p> </div> <div class="bottom_detail"> <ul> ', i(n.skillsClassify, function(t, e) {
	...
	t.exports = i("timeAxis-1", function(t, e) {
		...
		var s = this,
			...
			o = t.nums,
			l = "";
		return l += ' <div class="timeAxis" style="display:none"> <div class="timecon"> <div class="skills_title"> <h3>工作时光轴</h3> <p>有大型网站开发、优化经验</p> </div> <div class="timeline_top"> <div class="dot"></div> <div class="line"></div> </div> <div class="exper_detail"> ', n(a, function(t, e) {
	...
	var i = s(3);
	t.exports = i("footer", '<div class="footer"> <div class="footcon clearfix"> <div class="footleft"> <p>杨智博</p> <p>电话：152-1079-5251</p> <p>邮箱：jimaoshitang@gmail.com</p> </div> </div> </div>')
}, function(t, e, s) {
	function i(t, e) {
